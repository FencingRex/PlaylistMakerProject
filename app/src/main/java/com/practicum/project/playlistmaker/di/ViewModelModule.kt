...
import com.practicum.project.playlistmaker.editplaylist.ui.EditPlaylistViewModel
...
import com.practicum.project.playlistmaker.playlist.ui.PlaylistViewModel
...
val viewModelModule = module {
    ...
    viewModel { params ->
        PlaylistViewModel(params.get(),get(),get())
    }
    viewModel { params ->
        EditPlaylistViewModel(params.get(),get( ) )
    }
}
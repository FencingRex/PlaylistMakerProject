...
open class PlaylistsViewModel(private val playlistInteractor: PlaylistInteractor): ViewModel() {
    ...
    val playlistStateLiveData: LiveData<PlaylistState> = playlistLiveData
